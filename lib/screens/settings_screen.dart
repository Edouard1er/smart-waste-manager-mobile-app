...
class SettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    WasteBin(id: 1, latitude: 37.7749, longitude: -122.4214, fillLevel: 0.98, nextCollectionDate: DateTime.now(), status: ''),
    WasteBin(id: 2, latitude: 37.7839, longitude: -122.4214, fillLevel: 0.7, nextCollectionDate: DateTime.now(), status: ''),
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  // MaterialPageRoute(builder: (context) => NextCollectScreen(wasteBins: wasteBins)),
                    MaterialPageRoute(builder: (context) => VilleCollection(wasteBins: wasteBins)),
                );
                // Ajoutez ici la logique pour naviguer vers l'écran de configuration des rappels
              },
            ),
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  // MaterialPageRoute(builder: (context) => NextCollectScreen(wasteBins: wasteBins)),
                    MaterialPageRoute(builder: (context) => Bienvenu(wasteBins: wasteBins)),
                );
                // Ajoutez ici la logique pour naviguer vers l'écran de configuration des rappels
              },
            ),
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  // MaterialPageRoute(builder: (context) => NextCollectScreen(wasteBins: wasteBins)),
                    MaterialPageRoute(builder: (context) => BienvenuPhone(wasteBins: wasteBins)),
                );
                // Ajoutez ici la logique pour naviguer vers l'écran de configuration des rappels
              },
            ),
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  // MaterialPageRoute(builder: (context) => NextCollectScreen(wasteBins: wasteBins)),
                    MaterialPageRoute(builder: (context) => ChoixQuartier(wasteBins: wasteBins)),
                );
                // Ajoutez ici la logique pour naviguer vers l'écran de configuration des rappels
              },
            ),
